...
export function Sakura(props) {
  const { nodes, materials } = useGLTF('/models/sakura/model.glb')
  ...
  return (
    <group {...props} dispose={null}>
      <mesh geometry={nodes['??????????_1'].geometry}>
      ...
      <mesh geometry={nodes['??????????_1_1'].geometry}>
        <meshStandardMaterial
          {...materials['???????_??????']}
          transparent
          onBeforeCompile={applyFadeEffect}
...
useGLTF.preload('/models/sakura/model.glb')