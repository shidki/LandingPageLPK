...
Command: npx gltfjsx@6.5.3 public/models/pagoda/model.glb --output src/components/Pagoda.jsx 
*/
...
export function Pagoda(props) {
  const { nodes, materials } = useGLTF('/models/pagoda/model.glb')
...
useGLTF.preload('/models/pagoda/model.glb')
